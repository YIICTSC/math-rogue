...
- Steamworksのリリースチェックリストでは、基本情報、説明、コンテンツアンケート、
  ...
  ライブラリアセット、アプリ／ショートカットアイコン、予告編、公開価格。
- パッケージ`1738674`は日本500円と地域別推奨価格を提出済み。価格画面では
  「価格は提出済みで、レビュー待ち」と表示され、現在価格は未設定のため、
  Valveの価格審査完了後に公開価格チェックが完了する。
...
知識を力に、学びを冒険に。100,000問以上を収録した、学びながら楽しむデッキ構築ローグライク。

### 詳しい説明

知識を力に、学びを冒険に。

「学習ローグ」は、問題に答えながらカードやレリックを集め、デッキを育てて冒険する学習ローグライクです。小・中学校の学習指導要領に沿った単元を中心に、高校以上・大人まで楽しめる問題を100,000問以上収録。正解を重ねるほど、カードバトルと冒険の可能性が広がります。

### 主な特徴

- 「学習ローグ」は、問題に答えながらカードやレリックを集め、デッキを育てて冒険する学習ローグライク
- 小学1年〜中学3年を中心に、算数・数学、国語・漢字、英語、生活、理科、社会など幅広い分野に対応
- 高校以上・大人向けの数学、理科、社会、英語、情報、小論文、実用分野も収録
- 選択式と入力式、問題読み上げ、ひらがな中心表示、英語表示に対応
- カードバトル、マップ分岐、イベント、ショップ、ボス戦、カードの強化・合成、レリック、ポーション
...
- PC版は買い切りで、ゲーム内の1日プレイ時間制限なし

### 保護者・教員向け管理ポータル

課題配信や学習状況の確認に利用できる管理ポータル：
...
- オンライン機能は任意です。公開ランキングでは、実名や個人を特定できる名前を使用しないでください。
