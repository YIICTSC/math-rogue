...
const CompendiumScreen: React.FC<CompendiumScreenProps> = ({ unlockedCardNames, onBack }) => {
  ...
  const unlockedCount = unlockedCardNames.length; // Note: This might include cards not in current library if library changed, but roughly ok
  // More accurate count based on current library
