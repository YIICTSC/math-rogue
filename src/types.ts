...
export enum GameScreen {
  ...
  RPG_ONLINE = 'RPG_ONLINE',
  DODGEBALL_SHOOTING = 'DODGEBALL_SHOOTING',
  BASKETBALL_LAYUP = 'BASKETBALL_LAYUP',
  ...
  MINI_GAME_STONE_GLOW = 'MINI_GAME_STONE_GLOW',
  MINI_GAME_SCHOOL_TRPG = 'MINI_GAME_SCHOOL_TRPG',
  MINI_GAME_LEARNING_TCG = 'MINI_GAME_LEARNING_TCG',
  MINI_GAME_SHOGI = 'MINI_GAME_SHOGI',
...
export enum GameMode {
  ...
  UPPER_ENGLISH_WORDS = 'UPPER_ENGLISH_WORDS',
  UPPER_ENGLISH_ACADEMIC = 'UPPER_ENGLISH_ACADEMIC',
  UPPER_ENGLISH_DAILY = 'UPPER_ENGLISH_DAILY',
  UPPER_ENGLISH_BUSINESS = 'UPPER_ENGLISH_BUSINESS',
  UPPER_ENGLISH_SCIENCE = 'UPPER_ENGLISH_SCIENCE',
  UPPER_ENGLISH_TECH = 'UPPER_ENGLISH_TECH',
  UPPER_ENGLISH_EXAM = 'UPPER_ENGLISH_EXAM',
  UPPER_ENGLISH_SOCIAL = 'UPPER_ENGLISH_SOCIAL',
  UPPER_ENGLISH_TRAVEL = 'UPPER_ENGLISH_TRAVEL',
  UPPER_INFORMATION = 'UPPER_INFORMATION',
  UPPER_TRIVIA = 'UPPER_TRIVIA',
  HOBBY_BOARD_GAMES = 'HOBBY_BOARD_GAMES',
  HOBBY_TRPG = 'HOBBY_TRPG',
  HOBBY_CARD_GAMES = 'HOBBY_CARD_GAMES',
  HOBBY_SHOGI = 'HOBBY_SHOGI',
  HOBBY_GO = 'HOBBY_GO',
  HOBBY_CHESS = 'HOBBY_CHESS',
  HOBBY_MAHJONG = 'HOBBY_MAHJONG',
  HOBBY_FISHING = 'HOBBY_FISHING',
  HOBBY_CAMPING = 'HOBBY_CAMPING',
  HOBBY_HIKING = 'HOBBY_HIKING',
  HOBBY_PHOTOGRAPHY = 'HOBBY_PHOTOGRAPHY',
  HOBBY_VIDEO = 'HOBBY_VIDEO',
  HOBBY_MUSIC_LISTENING = 'HOBBY_MUSIC_LISTENING',
  HOBBY_INSTRUMENTS = 'HOBBY_INSTRUMENTS',
  HOBBY_GARDENING = 'HOBBY_GARDENING',
  HOBBY_COOKING = 'HOBBY_COOKING',
  HOBBY_BAKING = 'HOBBY_BAKING',
  HOBBY_HANDICRAFT = 'HOBBY_HANDICRAFT',
  HOBBY_PLASTIC_MODELS = 'HOBBY_PLASTIC_MODELS',
  HOBBY_RAILWAY = 'HOBBY_RAILWAY',
  HOBBY_BICYCLE = 'HOBBY_BICYCLE',
  HOBBY_ASTRONOMY = 'HOBBY_ASTRONOMY',
  HOBBY_INSECTS = 'HOBBY_INSECTS',
  HOBBY_AQUARIUM_FISH = 'HOBBY_AQUARIUM_FISH',
  HOBBY_ZOO_ANIMALS = 'HOBBY_ZOO_ANIMALS',
  ...
  NATIVE_ELA_G1 = 'NATIVE_ELA_G1',
  NATIVE_ELA_G2 = 'NATIVE_ELA_G2',
  NATIVE_ELA_G3 = 'NATIVE_ELA_G3',
  NATIVE_MATH_G1 = 'NATIVE_MATH_G1',
  NATIVE_MATH_G2 = 'NATIVE_MATH_G2',
  NATIVE_MATH_G3 = 'NATIVE_MATH_G3',
  NATIVE_SCIENCE_G1 = 'NATIVE_SCIENCE_G1',
  NATIVE_SCIENCE_G2 = 'NATIVE_SCIENCE_G2',
  NATIVE_SCIENCE_G3 = 'NATIVE_SCIENCE_G3',
  NATIVE_SOCIAL_G1 = 'NATIVE_SOCIAL_G1',
  NATIVE_SOCIAL_G2 = 'NATIVE_SOCIAL_G2',
  NATIVE_SOCIAL_G3 = 'NATIVE_SOCIAL_G3',
  NATIVE_JAPANESE_G1 = 'NATIVE_JAPANESE_G1',
  NATIVE_JAPANESE_G2 = 'NATIVE_JAPANESE_G2',
  NATIVE_JAPANESE_G3 = 'NATIVE_JAPANESE_G3',
  ...
  PREF_HOKKAIDO = 'PREF_HOKKAIDO',
  PREF_AOMORI = 'PREF_AOMORI',
  PREF_IWATE = 'PREF_IWATE',
  PREF_MIYAGI = 'PREF_MIYAGI',
  PREF_AKITA = 'PREF_AKITA',
  PREF_YAMAGATA = 'PREF_YAMAGATA',
  PREF_FUKUSHIMA = 'PREF_FUKUSHIMA',
  PREF_IBARAKI = 'PREF_IBARAKI',
  PREF_TOCHIGI = 'PREF_TOCHIGI',
  PREF_GUNMA = 'PREF_GUNMA',
  PREF_SAITAMA = 'PREF_SAITAMA',
  PREF_CHIBA = 'PREF_CHIBA',
  PREF_TOKYO = 'PREF_TOKYO',
  PREF_KANAGAWA = 'PREF_KANAGAWA',
  PREF_NIIGATA = 'PREF_NIIGATA',
  PREF_TOYAMA = 'PREF_TOYAMA',
  PREF_ISHIKAWA = 'PREF_ISHIKAWA',
  PREF_FUKUI = 'PREF_FUKUI',
  PREF_YAMANASHI = 'PREF_YAMANASHI',
  PREF_NAGANO = 'PREF_NAGANO',
  PREF_GIFU = 'PREF_GIFU',
  PREF_SHIZUOKA = 'PREF_SHIZUOKA',
  PREF_AICHI = 'PREF_AICHI',
  PREF_MIE = 'PREF_MIE',
  PREF_SHIGA = 'PREF_SHIGA',
  PREF_KYOTO = 'PREF_KYOTO',
  PREF_OSAKA = 'PREF_OSAKA',
  PREF_HYOGO = 'PREF_HYOGO',
  PREF_NARA = 'PREF_NARA',
  PREF_WAKAYAMA = 'PREF_WAKAYAMA',
  PREF_TOTTORI = 'PREF_TOTTORI',
  PREF_SHIMANE = 'PREF_SHIMANE',
  PREF_OKAYAMA = 'PREF_OKAYAMA',
  PREF_HIROSHIMA = 'PREF_HIROSHIMA',
  PREF_YAMAGUCHI = 'PREF_YAMAGUCHI',
  PREF_TOKUSHIMA = 'PREF_TOKUSHIMA',
  PREF_KAGAWA = 'PREF_KAGAWA',
  PREF_EHIME = 'PREF_EHIME',
  PREF_KOCHI = 'PREF_KOCHI',
  PREF_FUKUOKA = 'PREF_FUKUOKA',
  PREF_SAGA = 'PREF_SAGA',
  PREF_NAGASAKI = 'PREF_NAGASAKI',
  PREF_KUMAMOTO = 'PREF_KUMAMOTO',
  PREF_OITA = 'PREF_OITA',
  PREF_MIYAZAKI = 'PREF_MIYAZAKI',
  PREF_KAGOSHIMA = 'PREF_KAGOSHIMA',
  PREF_OKINAWA = 'PREF_OKINAWA',
