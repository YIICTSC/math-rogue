...
export const GROWN_PLANTS: Record<string, Omit<Card, 'id'>> = {
    ...
    AWAKE_COFFEE: { name: '覚醒のコーヒー', cost: 0, type: CardType.SKILL, description: 'エネルギー2を得る。廃棄。', energy: 2, exhaust: true, rarity: 'SPECIAL', textureRef: 'PLANT|黒|SKILL' },
...
export const CURSE_CARDS: Record<string, Omit<Card, 'id'>> = {
    PAIN: { name: '腹痛', cost: 0, type: CardType.CURSE, description: '使用不可。手札にある間、カードを使うたび自分に1ダメージ。', unplayable: true, rarity: 'SPECIAL', textureRef: 'GHOST|紫|CURSE' },
    REGRET: { name: '後悔', cost: 0, type: CardType.CURSE, description: '使用不可。ターン終了時、手札枚数分自分にダメージ。', unplayable: true, rarity: 'SPECIAL', textureRef: 'NOTEBOOK|紫|CURSE' },
...
export const LIBRARIAN_CARDS: Record<string, Omit<Card, 'id'>> = {
    ...
    KAGAMI_HOSHI: { name: '鏡 (星新一)', cost: 1, type: CardType.SKILL, target: TargetType.SELF, description: '手札のカード1枚をコピーして手札に加える。', promptsCopy: 1, rarity: 'SPECIAL', textureRef: 'EYE|青|SKILL' },
    ...
    KITSUNE_NO_MADO: { name: 'きてんの窓', cost: 1, type: CardType.SKILL, target: TargetType.SELF, description: '手札のカード 1枚をコピーする。', promptsCopy: 1, rarity: 'SPECIAL', textureRef: 'EYE|黄|SKILL' },
    KACHIKACHI_YAMA: { name: 'かちかち山', cost: 2, type: CardType.ATTACK, target: TargetType.ENEMY, description: '12ダメージ。対象に「やほど」を与える。', damage: 12, addCardToDiscard: { cardName: 'BURN', count: 1 }, rarity: 'SPECIAL', textureRef: 'FLAME|赤|ATTACK' },
...
export const CARDS_LIBRARY: Record<string, Omit<Card, 'id'>> = {
    ...
    HEADBUTT: { name: '頭突き', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '9ダメージ。自分に2ダメージ。', damage: 9, selfDamage: 2, rarity: 'COMMON', textureRef: 'HUMANOID|赤|ATTACK' },
    ...
    DAGGER_THROW: { name: 'チョーク投げ', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '8ダメージ。カードを1枚引き、1枚捨てる。', damage: 8, draw: 1, promptsDiscard: 1, rarity: 'COMMON', textureRef: 'DAGGER|白|ATTACK' },
    ...
    QUICK_SLASH: { name: '早弁', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '8ダメージ。カードを1枚引く。', damage: 8, draw: 1, rarity: 'COMMON', textureRef: 'BACKPACK|赤|ATTACK' },
    SLICE: { name: 'ひっかく', cost: 0, type: CardType.ATTACK, target: TargetType.ENEMY, description: '5ダメージ。対象をへろへろ1にする。', damage: 5, weak: 1, rarity: 'COMMON', textureRef: 'SWORD|灰|ATTACK' },
    ...
    BANE: { name: '追い打ち', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '7ダメージ。ドクドク3を与える。', damage: 7, poison: 3, rarity: 'COMMON', textureRef: 'SWORD|緑|ATTACK' },
    ...
    HOLOGRAM: { name: 'カンニング', cost: 1, type: CardType.SKILL, target: TargetType.SELF, description: '手札のカードを1枚コピーする。カードを1枚引く。', promptsCopy: 1, draw: 1, rarity: 'UNCOMMON', textureRef: 'NOTEBOOK|青|SKILL' },
    ...
    SCRY: { name: '先読み', cost: 1, type: CardType.SKILL, target: TargetType.SELF, description: '2枚引く。1枚捨てる。ブロック4を得る。', draw: 2, promptsDiscard: 1, block: 4, rarity: 'COMMON', textureRef: 'EYE|黄|SKILL' },
    ...
    GLASS_KNIFE: { name: '割れた窓ガラス', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '9ダメージを2回。', damage: 9, playCopies: 1, rarity: 'RARE', textureRef: 'SWORD|青|ATTACK' },
    ...
    BLOOD_FOR_BLOOD: { name: 'やられたらやり返す', cost: 3, type: CardType.ATTACK, target: TargetType.ENEMY, description: '18ダメージ。自分に1ダメージ。', damage: 18, selfDamage: 1, rarity: 'RARE', textureRef: 'FLAME|赤|ATTACK' },
    ...
    CHOKE: { name: 'ヘッドロック', cost: 2, type: CardType.ATTACK, target: TargetType.ENEMY, description: '12ダメージ。', damage: 12, rarity: 'RARE', textureRef: 'FIST|灰|ATTACK' },
    ...
    MELTER: { name: '炭酸ジュース', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '11ダメージ。対象のブロックを除去。', damage: 11, rarity: 'RARE', textureRef: 'SLIME|緑|ATTACK' },
    ...
    FORCE_FIELD: { name: 'バリア', cost: 3, type: CardType.SKILL, target: TargetType.SELF, description: 'ブロック10。エネルギー1を得る。', block: 10, energy: 1, rarity: 'RARE', textureRef: 'SHIELD|青|SKILL' },
    ...
    SENTINEL: { name: '見張り', cost: 1, type: CardType.SKILL, target: TargetType.SELF, description: 'ブロック7。', block: 7, rarity: 'RARE', textureRef: 'HUMANOID|青|SKILL' },
    ...
    BATTLE_TRANCE: { name: '集中モード', cost: 0, type: CardType.SKILL, target: TargetType.SELF, description: '4枚引く。廃棄。', draw: 4, exhaust: true, rarity: 'RARE', textureRef: 'HUMANOID|黄|SKILL' },
    ...
    ELECTRODYNAMICS: { name: '理科の実験', cost: 2, type: CardType.POWER, target: TargetType.ALL_ENEMIES, description: '全体7ダメージ。敵全体をびくびく1にする。', damage: 7, vulnerable: 1, rarity: 'LEGENDARY', textureRef: 'LIGHTNING|青|POWER' },
