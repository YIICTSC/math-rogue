...
export const LIBRARIAN_CARDS: Record<string, Omit<Card, 'id'>> = {
    ...
    KOROSHIYA: { name: '殺し屋ですのよ', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '9ダメージ。解決するとエネルギー2を得る。', damage: 9, fatalEnergy: 2, rarity: 'SPECIAL', textureRef: 'DAGGER|紫|ATTACK' },
...
export const CARDS_LIBRARY: Record<string, Omit<Card, 'id'>> = {
  ...
  CAPTURE_NET: { name: '捕獲網', cost: 2, type: CardType.ATTACK, target: TargetType.ENEMY, description: '10ダメージ。これで解決すると敵をカード化してデッキに加える。廃棄。', damage: 10, capture: true, exhaust: true, rarity: 'SPECIAL', textureRef: 'BACKPACK|黄|ATTACK' },
  ...
  FEED: { name: 'いただきます', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '10ダメージ。これで解決すると最大HP+3。', damage: 10, fatalMaxHp: 3, rarity: 'RARE', textureRef: 'FIST|赤|ATTACK' },
  ...
  SUNDER: { name: 'ビリビリに破る', cost: 3, type: CardType.ATTACK, target: TargetType.ENEMY, description: '24ダメージ。解決すればE3回復。', damage: 24, fatalEnergy: 3, rarity: 'RARE', textureRef: 'FIST|赤|ATTACK' },
  ...
  LESSON_LEARNED: { name: '学習', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '10ダメージ。解決すると最大HPが恒久的に2増加する。廃棄。', damage: 10, fatalMaxHp: 2, exhaust: true, rarity: 'RARE', textureRef: 'NOTEBOOK|黄|ATTACK' },
  ...
  RITUAL_DAGGER: { name: '伝説の鉛筆', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '15ダメージ。敵を解決すると恒久+3強化。廃棄。', damage: 15, fatalPermanentDamage: 3, exhaust: true, rarity: 'RARE', textureRef: 'SWORD|赤|ATTACK' },
  ...
  CORPSE_EXPLOSION: { name: '衝撃のうわさ', cost: 2, type: CardType.SKILL, target: TargetType.ENEMY, description: 'ドクドク6。解決すると全体に最大HPダメージ。', poison: 6, applyPower: { id: 'CORPSE_EXPLOSION', amount: 1 }, rarity: 'LEGENDARY', textureRef: 'GHOST|緑|SKILL' },
