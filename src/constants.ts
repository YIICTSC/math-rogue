...
export const RELIC_LIBRARY: Record<string, Relic> = {
    ...
    KUNAI: { id: 'KUNAI', name: '折り紙の手裏剣', description: '1ターンにアタックを3枚使う度、敏捷性(Block+)1を得る。', rarity: 'RARE', price: 280 },
    SHURIKEN: { id: 'SHURIKEN', name: '紙飛行機', description: '1ターンにアタックを3枚使う度、筋力1を得る。', rarity: 'RARE', price: 280 },
...
export const EVENT_CARDS: Record<string, Omit<Card, 'id'>> = {
    ...
    APPARITION: { name: 'ドロン', cost: 1, type: CardType.SKILL, target: TargetType.SELF, description: '無敵(被ダメ1)を得る。廃棄。', applyPower: { id: 'INTANGIBLE', amount: 1 }, exhaust: true, rarity: 'SPECIAL' },
...
export const CARDS_LIBRARY: Record<string, Omit<Card, 'id'>> = {
  ...
  SUCKER_PUNCH: { name: 'カンチョー', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '7ダメージ。弱体1を与える。', damage: 7, weak: 1, rarity: 'COMMON' },
  BANE: { name: '追い打ち', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '7ダメージ。敵が毒状態なら更に7ダメージ。', damage: 7, rarity: 'COMMON' }, 
  ...
  BLIND: { name: '目隠し', cost: 0, type: CardType.SKILL, target: TargetType.ENEMY, description: '弱体2を与える。', weak: 2, rarity: 'COMMON' },
  TRIP: { name: '足払い', cost: 0, type: CardType.SKILL, target: TargetType.ALL_ENEMIES, description: '敵全体に脆弱2を与える。', vulnerable: 2, rarity: 'COMMON' },
...
export const CHARACTERS: Character[] = [
    ...
    },
    {
        id: 'ASSASSIN',
        name: '転校生',
        description: 'ミステリアスな転校生。毒（悪口）や手数を操る。',
        maxHp: 70,
        gold: 100,
