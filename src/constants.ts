...
export const RELIC_LIBRARY: Record<string, Relic> = {
    ...
    FROZEN_EYE: { id: 'FROZEN_EYE', name: '観察メモ', description: '敵の次の行動が見えやすくなる。', rarity: 'SHOP', price: 180 },
...
export const CARDS_LIBRARY: Record<string, Omit<Card, 'id'>> = {
    ...
    DUAL_WIELD: { name: '二本鉛筆', cost: 1, type: CardType.SKILL, target: TargetType.SELF, description: '手札の攻撃/パワーを1枚選び、2枚コピー。', promptsCopy: 1, rarity: 'RARE', textureRef: 'NOTEBOOK|灰|SKILL' },
