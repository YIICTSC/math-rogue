...
export const CARDS_LIBRARY: Record<string, Omit<Card, 'id'>> = {
  ...
  LESSON_LEARNED: { name: '学習', cost: 2, type: CardType.ATTACK, target: TargetType.ENEMY, description: '10ダメージ。解決するとランダムなカード強化。', damage: 10, fatalPermanentDamage: 3, rarity: 'RARE', textureRef: 'NOTEBOOK|黄|ATTACK' },
  ...
  THOUSAND_CUTS: { name: '千本ノック', cost: 2, type: CardType.POWER, target: TargetType.SELF, description: 'カード使用時全体1ダメージ。', applyPower: { id: 'THOUSAND_CUTS', amount: 1 }, rarity: 'RARE', textureRef: 'FIST|赤|POWER' },
