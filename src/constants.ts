...
export const CARDS_LIBRARY: Record<string, Omit<Card, 'id'>> = {
  ...
  THUNDERCLAP: { name: '大声', cost: 1, type: CardType.ATTACK, target: TargetType.ALL_ENEMIES, description: '敵全体に4ダメージとびくびく1。', damage: 4, vulnerable: 1, rarity: 'COMMON' },
  TWIN_STRIKE: { name: '往復ビンタ', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '5ダメージを2回与える。', damage: 5, playCopies: 1, rarity: 'COMMON' },
  ...
  POISON_STAB: { name: '毒舌', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '6ダメージ。ドクドク3を与える。', damage: 6, poison: 3, rarity: 'COMMON' },
  ...
  SLICE: { name: 'ひっかく', cost: 0, type: CardType.ATTACK, target: TargetType.ENEMY, description: '6ダメージ。', damage: 6, rarity: 'COMMON' },
  BEAM_CELL: { name: 'レーザーポインター', cost: 0, type: CardType.ATTACK, target: TargetType.ENEMY, description: '4ダメージ。びくびく1を与える。', damage: 4, vulnerable: 1, rarity: 'COMMON' },
  ...
  SASH_WHIP: { name: 'タオル攻撃', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '8ダメージ。へろへろ1。', damage: 8, weak: 1, rarity: 'COMMON' },
  CLASH: { name: '口喧嘩', cost: 0, type: CardType.ATTACK, target: TargetType.ENEMY, description: '14ダメージ。手札がアタックのみの時のみ使用可。', damage: 14, rarity: 'COMMON' }, 
  ...
  HEAVY_BLADE: { name: '重いバット', cost: 2, type: CardType.ATTACK, target: TargetType.ENEMY, description: '14ダメージ。ムキムキ効果3倍。', damage: 14, strengthScaling: 3, rarity: 'RARE' },
  ...
  CORE_SURGE: { name: '暴走', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '11ダメージ。キラキラ1を得る。', damage: 11, exhaust: true, applyPower: { id: 'ARTIFACT', amount: 1 }, rarity: 'RARE' },
  ...
  PREDATOR: { name: '捕食者', cost: 2, type: CardType.ATTACK, target: TargetType.ENEMY, description: '15ダメージ。次ターン2ドロー。', damage: 15, nextTurnDraw: 2, rarity: 'RARE' },
  ...
  DISARM: { name: '武器奪取', cost: 1, type: CardType.SKILL, target: TargetType.ENEMY, description: '敵のムキムキを2下げる。廃棄。', strength: -2, exhaust: true, rarity: 'RARE' },
  ...
  EVOLVE: { name: '進化', cost: 1, type: CardType.POWER, target: TargetType.SELF, description: '状態異常カードを引いた時、カードを引く。', applyPower: { id: 'EVOLVE', amount: 1 }, rarity: 'RARE' },
  ...
  STATIC_DISCHARGE: { name: '静電気', cost: 1, type: CardType.POWER, target: TargetType.SELF, description: '被ダメ時、ランダムに5ダメ。', applyPower: { id: 'STATIC_DISCHARGE', amount: 1 }, rarity: 'RARE' },
  ...
  DEVA_FORM: { name: 'デバ化', cost: 3, type: CardType.POWER, target: TargetType.SELF, description: 'ターン開始時、エネルギーを得る。毎ターン増加する。', applyPower: { id: 'DEVA_FORM', amount: 1 }, rarity: 'LEGENDARY' },
  ...
  BERSERK: { name: 'バーサク', cost: 0, type: CardType.POWER, target: TargetType.SELF, description: 'びくびく2を受け、エネルギー1を得る。', energy: 1, vulnerable: 2, rarity: 'RARE' },
