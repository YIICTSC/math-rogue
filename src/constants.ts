...
export const RELIC_LIBRARY: Record<string, Relic> = {
    ...
    LIZARD_TAIL: { id: 'LIZARD_TAIL', name: 'トカゲのしっぽ', description: '死亡時、HP50%で一度だけ復活する。', rarity: 'RARE', price: 300 },
...
export const POTION_LIBRARY: Record<string, Omit<Potion, 'id'>> = {
    ...
    POISON_POTION: { templateId: 'POISON_POTION', name: '墨汁', description: '敵1体に毒6を与える。', rarity: 'COMMON', color: '#4ade80', price: 50 },
    HEALTH_POTION: { templateId: 'HEALTH_POTION', name: 'フルーツポンチ', description: 'HPを15回復する。', rarity: 'RARE', color: '#4ade80', price: 100 },
    LIQUID_BRONZE: { templateId: 'LIQUID_BRONZE', name: '工作のり', description: 'トゲ3を得る。', rarity: 'UNCOMMON', color: '#d97706', price: 70 },
    GHOST_IN_JAR: { templateId: 'GHOST_IN_JAR', name: 'お守り', description: '使用すると「蘇生」を得る。死亡時、HP20%で復活。', rarity: 'RARE', color: '#fcd34d', price: 200 }, 
...
export const CURSE_CARDS: Record<string, Omit<Card, 'id'>> = {
    ...
    DOUBT: { name: '疑念', cost: 0, type: CardType.CURSE, description: '使用不可。ターン終了時、弱体1を得る。', unplayable: true, rarity: 'SPECIAL' },
    SHAME: { name: '恥辱', cost: 0, type: CardType.CURSE, description: '使用不可。ターン終了時、脆弱1を得る。', unplayable: true, rarity: 'SPECIAL' },
...
export const EVENT_CARDS: Record<string, Omit<Card, 'id'>> = {
    ...
    APPARITION: { name: '霊体化', cost: 1, type: CardType.SKILL, target: TargetType.SELF, description: '無敵(被ダメ1)を得る。廃棄。', applyPower: { id: 'INTANGIBLE', amount: 1 }, exhaust: true, rarity: 'SPECIAL' },
    J_A_X: { name: 'J.A.X.', cost: 0, type: CardType.SKILL, target: TargetType.SELF, description: '筋力3を得る。ターン終了時3失う。', strength: 3, applyPower: { id: 'LOSE_STRENGTH', amount: 3 }, rarity: 'SPECIAL' },
...
export const CARDS_LIBRARY: Record<string, Omit<Card, 'id'>> = {
  ...
  BASH: { name: '強打', cost: 2, type: CardType.ATTACK, target: TargetType.ENEMY, description: '8ダメージ。対象に脆弱2を与える。', damage: 8, vulnerable: 2, rarity: 'COMMON' },
  NEUTRALIZE: { name: '無力化', cost: 0, type: CardType.ATTACK, target: TargetType.ENEMY, description: '3ダメージ。対象に弱体1を与える。', damage: 3, weak: 1, rarity: 'COMMON' },
  ...
  THUNDERCLAP: { name: '雷鳴', cost: 1, type: CardType.ATTACK, target: TargetType.ALL_ENEMIES, description: '敵全体に4ダメージと脆弱1。', damage: 4, vulnerable: 1, rarity: 'COMMON' },
  ...
  POISON_STAB: { name: '毒突き', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '6ダメージ。毒3を与える。', damage: 6, poison: 3, rarity: 'COMMON' },
  ...
  BEAM_CELL: { name: 'ビーム', cost: 0, type: CardType.ATTACK, target: TargetType.ENEMY, description: '4ダメージ。脆弱1を与える。', damage: 4, vulnerable: 1, rarity: 'COMMON' },
  ...
  SASH_WHIP: { name: '帯叩き', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '8ダメージ。弱体1。', damage: 8, weak: 1, rarity: 'COMMON' },
  ...
  PIERCING_WAIL: { name: '金切り声', cost: 1, type: CardType.SKILL, target: TargetType.ALL_ENEMIES, description: '敵全体に弱体1を与える。廃棄。', weak: 1, exhaust: true, rarity: 'COMMON' },
  ...
  HOLOGRAM: { name: 'ホログラム', cost: 1, type: CardType.SKILL, target: TargetType.SELF, description: 'ブロック3。手札に捨て札から1枚戻す。', block: 3, rarity: 'COMMON' },
  ...
  HEAVY_BLADE: { name: '重打', cost: 2, type: CardType.ATTACK, target: TargetType.ENEMY, description: '14ダメージ。筋力効果3倍。', damage: 14, strengthScaling: 3, rarity: 'RARE' },
  ...
  CORE_SURGE: { name: 'コアサージ', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '11ダメージ。アーティファクト1を得る。', damage: 11, exhaust: true, applyPower: { id: 'ARTIFACT', amount: 1 }, rarity: 'RARE' },
  ...
  SEVER_SOUL: { name: '魂の切断', cost: 2, type: CardType.ATTACK, target: TargetType.ENEMY, description: '16ダメージ。手札の非攻撃カードを全廃棄。', damage: 16, promptsExhaust: 99, rarity: 'RARE' },
  ...
  FIEND_FIRE: { name: '鬼火', cost: 2, type: CardType.ATTACK, target: TargetType.ENEMY, description: '手札を全て廃棄。1枚につき7ダメージ。', damage: 0, damagePerCardInHand: 7, rarity: 'RARE' },
  ...
  MELTER: { name: '溶解', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '10ダメージ。対象のブロックを除去。', damage: 10, rarity: 'RARE' },
  ...
  APOTHEOSIS: { name: '神格化', cost: 2, type: CardType.SKILL, target: TargetType.SELF, description: 'この戦闘中、全カードをUG。廃棄。', upgradeDeck: true, exhaust: true, rarity: 'RARE' },
  ...
  BERSERK: { name: 'ベルセルク', cost: 0, type: CardType.POWER, target: TargetType.SELF, description: '脆弱2を受け、エネルギー1を得る。', energy: 1, vulnerable: 2, rarity: 'RARE' },
