...
export const LIBRARIAN_CARDS: Record<string, Omit<Card, 'id'>> = {
    ...
    RASHOMON: { name: '羅生門', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '10ダメージ。たおすと相手を廃棄。', damage: 10, promptsExhaust: 1, rarity: 'SPECIAL', textureRef: 'HUMANOID|黒|ATTACK' },
    ...
    KITSUNE_NO_MADO: { name: 'きつねの窓', cost: 1, type: CardType.SKILL, target: TargetType.SELF, description: '手札のカード1枚をコピーする。', promptsCopy: 1, rarity: 'SPECIAL', textureRef: 'EYE|黄|SKILL' },
...
export const CARDS_LIBRARY: Record<string, Omit<Card, 'id'>> = {
  ...
  IRON_WAVE: { name: '上履きキック', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '5ダメージ。ブロック5得る。', damage: 5, block: 5, rarity: 'COMMON', textureRef: 'SHOE|青|ATTACK' },
  ...
  COLD_SNAP: { name: '寒いギャグ', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '6ダメージ。ブロック4得る。', damage: 6, block: 4, rarity: 'COMMON', textureRef: 'FLAME|青|ATTACK' },
  ...
  SUCKER_PUNCH: { name: 'カンチョー', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '7ダメージ。へろろ1を与える。', damage: 7, weak: 1, rarity: 'COMMON', textureRef: 'FIST|赤|ATTACK' },
  ...
  DEFLECT: { name: '回避', cost: 0, type: CardType.SKILL, target: TargetType.SELF, description: 'ブロック4得る。', block: 4, rarity: 'COMMON', textureRef: 'SHOE|白|SKILL' },
  ...
  LEAP: { name: 'ジャンプ', cost: 1, type: CardType.SKILL, target: TargetType.SELF, description: 'ブロック9得る。', block: 9, rarity: 'COMMON', textureRef: 'SHOE|青|SKILL' },
  ...
  RIDDLE_WITH_HOLES: { name: '穴だらけ', cost: 2, type: CardType.ATTACK, target: TargetType.ENEMY, description: '3ダメージを3回。', damage: 3, playCopies: 4, rarity: 'RARE', textureRef: 'FIST|灰|ATTACK' },
