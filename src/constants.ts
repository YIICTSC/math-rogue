...
import { Card, CardType, TargetType, Relic, Potion, Enemy, EnemyIntentType } from './types';
...
export const RELIC_LIBRARY: Record<string, Relic> = {
    ...
    VAJRA: { id: 'VAJRA', name: '金剛杵', description: '戦闘開始時、ムキムキ1を得る。', rarity: 'COMMON', price: 150 },
    ...
    BRONZE_SCALES: { id: 'BRONZE_SCALES', name: '銅の鱗', description: '戦闘開始時、トゲトゲ3を得る。', rarity: 'RARE', price: 200 },
    ...
    PHILOSOPHER_STONE: { id: 'PHILOSOPHER_STONE', name: '賢者の石', description: '毎ターンE+1。敵のムキムキ+1。', rarity: 'BOSS' },
    VELVET_CHOKER: { id: 'VELVET_CHOKER', name: 'ベルベットチョーカー', description: '毎ターンE+1。カードを6枚までしかプレイできない。', rarity: 'BOSS' },

    // Event Relics
    GOLDEN_IDOL: { id: 'GOLDEN_IDOL', name: '黄金の偶像', description: '敵が落とすゴールドが25%増える。', rarity: 'RARE' },
    MUTAGENIC_STRENGTH: { id: 'MUTAGENIC_STRENGTH', name: '変異性筋力', description: '戦闘開始時、ムキムキ3を得る。ターン終了時失う。', rarity: 'RARE' },
    WARPED_TONGS: { id: 'WARPED_TONGS', name: '歪んだトング', description: 'ターン開始時、手札のランダムなカードを強化する。', rarity: 'RARE' },
    RED_MASK: { id: 'RED_MASK', name: '赤仮面', description: '戦闘開始時、敵全体にへろへろ1を与える。', rarity: 'RARE' },
...
export const POTION_LIBRARY: Record<string, Omit<Potion, 'id'>> = {
    ...
    STRENGTH_POTION: { templateId: 'STRENGTH_POTION', name: 'ムキムキポーション', description: 'ムキムキ2を得る。', rarity: 'COMMON', color: '#ef4444', price: 75 },
    ENERGY_POTION: { templateId: 'ENERGY_POTION', name: 'エナジーポーション', description: 'エネルギー2を得る。', rarity: 'COMMON', color: '#fbbf24', price: 50 },
    WEAK_POTION: { templateId: 'WEAK_POTION', name: 'へろへろポーション', description: '敵1体にへろへろ3を与える。', rarity: 'COMMON', color: '#9ca3af', price: 40 },
    HEALTH_POTION: { templateId: 'HEALTH_POTION', name: '回復ポーション', description: 'HPを15回復する。', rarity: 'RARE', color: '#4ade80', price: 100 },
};
...
export const CURSE_CARDS: Record<string, Omit<Card, 'id'>> = {
    ...
    DOUBT: { name: '疑念', cost: 0, type: CardType.CURSE, description: '使用不可。ターン終了時、へろへろ1を得る。', unplayable: true, rarity: 'SPECIAL' },
    SHAME: { name: '恥辱', cost: 0, type: CardType.CURSE, description: '使用不可。ターン終了時、びくびく1を得る。', unplayable: true, rarity: 'SPECIAL' },
...
export const CARDS_LIBRARY: Record<string, Omit<Card, 'id'>> = {
  ...
  PERFECTED_STRIKE: { name: '完璧な打撃', cost: 2, type: CardType.ATTACK, target: TargetType.ENEMY, description: '6ダメージ。デッキの「ストライク」1枚につき+2。', damage: 6, damagePerStrike: 2, rarity: 'COMMON' },
  ANGER: { name: '怒り', cost: 0, type: CardType.ATTACK, target: TargetType.ENEMY, description: '6ダメージ。捨て札に「怒り」を1枚加える。', damage: 6, addCardToDiscard: { cardName: 'ANGER', count: 1 }, rarity: 'COMMON' },
  ...
  DISARM: { name: '武装解除', cost: 1, type: CardType.SKILL, target: TargetType.ENEMY, description: '敵のムキムキを2下げる。廃棄。', strength: -2, exhaust: true, rarity: 'RARE' },
  ...
  CATALYST: { name: '触媒', cost: 1, type: CardType.SKILL, target: TargetType.ENEMY, description: 'ドクドクを2倍にする。', poisonMultiplier: 2, exhaust: true, rarity: 'UNCOMMON' },
  ...
  APOTHEOSIS: { name: '神格化', cost: 2, type: CardType.SKILL, target: TargetType.SELF, description: '戦闘終了まで、手札を含む全カードをアップグレードする。廃棄。', upgradeDeck: true, exhaust: true, rarity: 'RARE' }
};
...
export const ENEMY_LIBRARY: Record<string, {name: string, tier: number}> = {
    "スライム": { name: "スライム", tier: 1 },
    "穢れたゴブリン": { name: "穢れたゴブリン", tier: 1 },
    "彷徨う骸骨": { name: "彷徨う骸骨", tier: 1 },
    "闇の司祭": { name: "闇の司祭", tier: 2 },
    "オークの戦士": { name: "オークの戦士", tier: 2 },
    "吸血コウモリ": { name: "吸血コウモリ", tier: 1 },
    "呪われた鎧": { name: "呪われた鎧", tier: 2 },
    "影の暗殺者": { name: "影の暗殺者", tier: 2 },
    "マッドゴーレム": { name: "マッドゴーレム", tier: 3 },
    "深淵の騎士": { name: "深淵の騎士", tier: 3 },
    "狂気の魔道士": { name: "狂気の魔道士", tier: 2 },
    "人食い植物": { name: "人食い植物", tier: 2 },
    "石像ガーゴイル": { name: "石像ガーゴイル", tier: 3 },
    "亡霊騎士": { name: "亡霊騎士", tier: 3 },
    "黒い霧": { name: "黒い霧", tier: 1 },
    "洞窟蜘蛛": { name: "洞窟蜘蛛", tier: 1 },
    "リザードマン": { name: "リザードマン", tier: 2 },
    "さまよう魂": { name: "さまよう魂", tier: 1 },
    "鉄の処女": { name: "鉄の処女", tier: 3 },
    "キメラ": { name: "キメラ", tier: 3 }
};
