...
export const CARDS_LIBRARY: Record<string, Omit<Card, 'id'>> = {
    ...
    CARD_ERASER: { name: 'カード消しゴム', cost: 0, type: CardType.SKILL, target: TargetType.SELF, description: '戦闘中は使用不可。放課後の自習でカードの不要な効果を1つ消す。', unplayable: true, eraserOnly: true, rarity: 'SPECIAL', textureRef: 'NOTEBOOK|青|SKILL' },
