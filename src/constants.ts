...
export const CARDS_LIBRARY: Record<string, Omit<Card, 'id'>> = {
  ...
  DEFEND: { name: 'ノートで防御', cost: 1, type: CardType.SKILL, target: TargetType.SELF, description: 'ブロックを5得る。', block: 5, rarity: 'COMMON', textureRef: 'SHIELD|青|SKILL' },
  BASH: { name: 'ランドセルタックル', cost: 2, type: CardType.ATTACK, target: TargetType.ENEMY, description: '8ダメージ。対象にびくびく2を与える。', damage: 8, vulnerable: 2, rarity: 'COMMON', textureRef: 'FIST|赤|ATTACK' },
  ...
  HEADBUTT: { name: '頭突き', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '9ダメージ。自傷2ダメージ。', damage: 9, selfDamage: 2, rarity: 'COMMON', textureRef: 'FIST|赤|ATTACK' },
  ...
  POISON_STAB: { name: '毒舌', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '6ダメージ。ドクドク3を与える。', damage: 6, poison: 3, rarity: 'COMMON', textureRef: 'SWORD|緑|ATTACK' },
  QUICK_SLASH: { name: '早弁', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '8ダメージ。カード1枚引く。', damage: 8, draw: 1, rarity: 'COMMON', textureRef: 'SWORD|赤|ATTACK' },
  ...
  COLD_SNAP: { name: '寒いギャグ', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '6ダメージ。ブロック4を得る。', damage: 6, block: 4, rarity: 'COMMON', textureRef: 'SLIME|青|ATTACK' },
  ...
  WILD_STRIKE: { name: '暴れる', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '12ダメージ。山札に「ケガ」を加える。', damage: 12, addCardToDraw: { cardName: 'WOUND', count: 1 }, rarity: 'COMMON', textureRef: 'FIST|赤|ATTACK' },
  ...
  FLYING_KNEE: { name: '飛び膝蹴り', cost: 1, type: CardType.ATTACK, target: TargetType.ENEMY, description: '8ダメージ。次ターンE+1。', damage: 8, nextTurnEnergy: 1, rarity: 'COMMON', textureRef: 'FIST|赤|ATTACK' },
  ...
  CONSECRATE: { name: '掃除の時間', cost: 0, type: CardType.ATTACK, target: TargetType.ALL_ENEMIES, description: '全体5ダメージ。', damage: 5, rarity: 'COMMON', textureRef: 'SLIME|灰|ATTACK' },
  ...
  CLASH: { name: '口喧嘩', cost: 0, type: CardType.ATTACK, target: TargetType.ENEMY, description: '14ダメージ。手札がアタックのみの時のみ使用可。', damage: 14, rarity: 'COMMON', textureRef: 'FLAME|赤|ATTACK' }, 
  ...
  SHIELD_BLOCK: { name: '盾構え', cost: 1, type: CardType.SKILL, target: TargetType.SELF, description: 'ブロックを7得る。', block: 7, rarity: 'COMMON', textureRef: 'SHIELD|青|SKILL' },
  SURVIVOR: { name: '生き残り', cost: 1, type: CardType.SKILL, target: TargetType.SELF, description: 'ブロック8。手札を1枚捨てる。', block: 8, promptsDiscard: 1, rarity: 'COMMON', textureRef: 'SHIELD|青|SKILL' },
  ...
  DEFLECT: { name: '回避', cost: 0, type: CardType.SKILL, target: TargetType.SELF, description: 'ブロック4を得る。', block: 4, rarity: 'COMMON', textureRef: 'SHIELD|青|SKILL' },
  PIERCING_WAIL: { name: '泣き叫ぶ', cost: 1, type: CardType.SKILL, target: TargetType.ALL_ENEMIES, description: '敵全体にムキムキダウン1を与える。廃棄。', strength: -6, exhaust: true, rarity: 'COMMON', textureRef: 'LIGHTNING|赤|SKILL' }, 
  ...
  ARMAMENTS: { name: '装備点検', cost: 1, type: CardType.SKILL, target: TargetType.SELF, description: 'ブロック5。手札全て強化。', block: 5, upgradeHand: true, rarity: 'COMMON', textureRef: 'HAMMER|黄|SKILL' },
  ...
  THIRD_EYE: { name: '予習', cost: 1, type: CardType.SKILL, target: TargetType.SELF, description: 'ブロック7。2枚ドロー。', block: 7, draw: 2, rarity: 'COMMON', textureRef: 'NOTEBOOK|青|SKILL' },
  ...
  SKIM: { name: '速読', cost: 1, type: CardType.SKILL, target: TargetType.SELF, description: '3枚引く。', draw: 3, rarity: 'COMMON', textureRef: 'NOTEBOOK|黄|SKILL' },
  ...
  DEEP_BREATH: { name: '深呼吸', cost: 0, type: CardType.SKILL, target: TargetType.SELF, description: '捨て札を山札に戻す。1枚引く。', shuffleHandToDraw: true, draw: 1, rarity: 'COMMON', textureRef: 'HUMANOID|白|SKILL' },
  ...
  REAPER: { name: '給食当番', cost: 2, type: CardType.ATTACK, target: TargetType.ALL_ENEMIES, description: '全体4ダメージ。未ブロック分HP回復。', damage: 4, lifesteal: true, rarity: 'RARE', textureRef: 'SLIME|緑|ATTACK' },
  ...
  GRAND_FINALE: { name: '卒業式', cost: 0, type: CardType.ATTACK, target: TargetType.ALL_ENEMIES, description: '全体50ダメージ。山札0の時のみ。', damage: 50, rarity: 'LEGENDARY', textureRef: 'BOSS|白|ATTACK' }, 
