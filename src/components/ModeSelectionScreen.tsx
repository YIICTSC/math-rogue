...
export const UPPER_PROBLEM_CATEGORIES: SubjectCategoryConfig[] = [
  ...
  },
  {
    ...
    uiType: 'grid',
    subModes: [
      { id: 'UPPER_ENGLISH', name: '高校英語基礎', mode: GameMode.UPPER_ENGLISH },
      { id: 'UPPER_ENGLISH_WORDS', name: '英単語総合', mode: GameMode.UPPER_ENGLISH_WORDS },
      { id: 'UPPER_ENGLISH_ACADEMIC', name: '学術・論説', mode: GameMode.UPPER_ENGLISH_ACADEMIC },
      { id: 'UPPER_ENGLISH_DAILY', name: '生活実用', mode: GameMode.UPPER_ENGLISH_DAILY },
      { id: 'UPPER_ENGLISH_BUSINESS', name: 'ビジネス・進路', mode: GameMode.UPPER_ENGLISH_BUSINESS },
      { id: 'UPPER_ENGLISH_SCIENCE', name: '科学', mode: GameMode.UPPER_ENGLISH_SCIENCE },
      { id: 'UPPER_ENGLISH_TECH', name: 'IT・テクノロジー', mode: GameMode.UPPER_ENGLISH_TECH },
      { id: 'UPPER_ENGLISH_EXAM', name: '入試・論理表現', mode: GameMode.UPPER_ENGLISH_EXAM },
      { id: 'UPPER_ENGLISH_SOCIAL', name: '社会・国際', mode: GameMode.UPPER_ENGLISH_SOCIAL },
      { id: 'UPPER_ENGLISH_TRAVEL', name: '旅行・文化', mode: GameMode.UPPER_ENGLISH_TRAVEL },
    ],
  },
  {
  ...
  },
  {
    ...
    uiType: 'grid',
    subModes: [
      { id: 'UPPER_TRIVIA', name: '一般常識・科学雑学', mode: GameMode.UPPER_TRIVIA },
      { id: 'HOBBY_BOARD_GAMES', name: 'ボードゲーム', mode: GameMode.HOBBY_BOARD_GAMES },
      { id: 'HOBBY_TRPG', name: 'TRPG', mode: GameMode.HOBBY_TRPG },
      { id: 'HOBBY_CARD_GAMES', name: 'カードゲーム', mode: GameMode.HOBBY_CARD_GAMES },
      { id: 'HOBBY_SHOGI', name: '将棋', mode: GameMode.HOBBY_SHOGI },
      { id: 'HOBBY_GO', name: '囲碁', mode: GameMode.HOBBY_GO },
      { id: 'HOBBY_CHESS', name: 'チェス', mode: GameMode.HOBBY_CHESS },
      { id: 'HOBBY_MAHJONG', name: '麻雀', mode: GameMode.HOBBY_MAHJONG },
      { id: 'HOBBY_FISHING', name: '釣り', mode: GameMode.HOBBY_FISHING },
      { id: 'HOBBY_CAMPING', name: 'キャンプ', mode: GameMode.HOBBY_CAMPING },
      { id: 'HOBBY_HIKING', name: '登山', mode: GameMode.HOBBY_HIKING },
      { id: 'HOBBY_PHOTOGRAPHY', name: '写真', mode: GameMode.HOBBY_PHOTOGRAPHY },
      { id: 'HOBBY_VIDEO', name: '動画制作', mode: GameMode.HOBBY_VIDEO },
      { id: 'HOBBY_MUSIC_LISTENING', name: '音楽鑑賞', mode: GameMode.HOBBY_MUSIC_LISTENING },
      { id: 'HOBBY_INSTRUMENTS', name: '楽器演奏', mode: GameMode.HOBBY_INSTRUMENTS },
      { id: 'HOBBY_GARDENING', name: '園芸', mode: GameMode.HOBBY_GARDENING },
      { id: 'HOBBY_COOKING', name: '料理', mode: GameMode.HOBBY_COOKING },
      { id: 'HOBBY_BAKING', name: 'お菓子作り', mode: GameMode.HOBBY_BAKING },
      { id: 'HOBBY_HANDICRAFT', name: '手芸', mode: GameMode.HOBBY_HANDICRAFT },
      { id: 'HOBBY_PLASTIC_MODELS', name: 'プラモデル', mode: GameMode.HOBBY_PLASTIC_MODELS },
      { id: 'HOBBY_RAILWAY', name: '鉄道', mode: GameMode.HOBBY_RAILWAY },
      { id: 'HOBBY_BICYCLE', name: '自転車', mode: GameMode.HOBBY_BICYCLE },
      { id: 'HOBBY_ASTRONOMY', name: '天体観測', mode: GameMode.HOBBY_ASTRONOMY },
      { id: 'HOBBY_INSECTS', name: '昆虫観察', mode: GameMode.HOBBY_INSECTS },
      { id: 'HOBBY_AQUARIUM_FISH', name: '水族館・魚', mode: GameMode.HOBBY_AQUARIUM_FISH },
      { id: 'HOBBY_ZOO_ANIMALS', name: '動物園・動物', mode: GameMode.HOBBY_ZOO_ANIMALS },
    ],
  },
  {
    id: 'UPPER_MATH',
...
const SUBMODE_LABELS: Record<string, string> = {
  ...
  HOBBY_BOARD_GAMES: 'ボードゲーム',
  HOBBY_TRPG: 'TRPG',
  HOBBY_CARD_GAMES: 'カードゲーム',
  HOBBY_SHOGI: '将棋',
  HOBBY_GO: '囲碁',
  HOBBY_CHESS: 'チェス',
  HOBBY_MAHJONG: '麻雀',
  ...
  HOBBY_CAMPING: 'キャンプ',
  HOBBY_HIKING: '登山',
  HOBBY_PHOTOGRAPHY: '写真',
  HOBBY_VIDEO: '動画制作',
  HOBBY_MUSIC_LISTENING: '音楽鑑賞',
  HOBBY_INSTRUMENTS: '楽器演奏',
  HOBBY_GARDENING: '園芸',
  HOBBY_COOKING: '料理',
  HOBBY_BAKING: 'お菓子作り',
  HOBBY_HANDICRAFT: '手芸',
  HOBBY_PLASTIC_MODELS: 'プラモデル',
  HOBBY_RAILWAY: '鉄道',
  HOBBY_BICYCLE: '自転車',
  HOBBY_ASTRONOMY: '天体観測',
  HOBBY_INSECTS: '昆虫観察',
  HOBBY_AQUARIUM_FISH: '水族館・魚',
  HOBBY_ZOO_ANIMALS: '動物園・動物',
        ...
        <div className="flex-grow grid grid-cols-1 lg:grid-cols-12 gap-4 p-4 overflow-hidden min-h-0">
          <div className="mode-category-list lg:col-span-2 grid grid-cols-3 sm:grid-cols-5 lg:flex lg:flex-col gap-1 lg:gap-1.5 pb-1 lg:pb-0 overflow-y-auto lg:overflow-x-visible custom-scrollbar shrink-0">
            {displayedCategories.map((cat, categoryIndex) => (
              <button
                key={cat.id}
                data-gamepad-initial-choice={categoryIndex === 0 ? true : undefined}
