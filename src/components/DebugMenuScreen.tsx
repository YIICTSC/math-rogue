...
const EVENT_SAMPLES = [
    ...
    { title: "修学旅行の積立金", description: "集集金袋を拾った。中にはお金が入っている。", options: [{ label: "ネコババ", text: "150G入手。呪い「後悔」を得る。", result: "150Gを手に入れた！しかし良心が痛む...呪い「後悔」を入手。" }, { label: "届ける", text: "職員室に届ける", result: "正直者は報われる。先生から「図書カード」をもらった！" }] },
