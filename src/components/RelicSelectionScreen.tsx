    ...
    <div className="flex flex-col h-full w-full bg-gray-900 text-white relative overflow-y-auto custom-scrollbar">
      ...
      <div className="z-10 flex flex-col items-center min-h-full justify-center p-4 py-8">
        <div className="text-center mb-8 shrink-0">
            ...
            <Gem className="mr-3" size={32} /> 旅の始まり
            </h2>
            <p className="text-sm md:text-xl text-gray-300">冒険の助けとなる遺物（レリック）を1つ選んでください</p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-4 md:gap-8 pb-8">
            ...
            >
                ...
                <h3 className="text-lg md:text-xl font-bold text-yellow-100 mb-2 group-hover:text-yellow-400">{relic.name}</h3>
                <p className="text-xs md:text-sm text-gray-400 text-center mb-4 min-h-[2.5rem] md:min-h-[3rem]">{relic.description}</p>
