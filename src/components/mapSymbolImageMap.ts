...
export const MAP_SYMBOL_ASSET_MAP: Record<string, MapSymbolAsset> = {
  city_office: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/f/f6/Japanese_Map_symbol_%28City_Hall%29.svg',
    sourcePage: 'https://commons.wikimedia.org/wiki/File:Japanese_Map_symbol_(City_Hall).svg',
    title: 'Japanese Map symbol (City Hall)',
    license: 'Public domain',
  },
  town_office: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/b/ba/Japanese_Map_symbol_%28Town_or_Village_Office%29.svg',
  ...
  school: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/b/b8/Japanese_Map_symbol_%28Elementary_or_Junior_high_school%29.svg',
  ...
  post_office: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/f/f7/Japanese_Map_symbol_%28Post_office%29.svg',
  ...
  temple: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/3/3b/Japanese_Map_symbol_%28Temple%29.svg',
    sourcePage: 'https://commons.wikimedia.org/wiki/File:Japanese_Map_symbol_(Temple).svg',
    title: 'Japanese Map symbol (Temple)',
    license: 'Public domain',
  },
  shrine: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/4/4a/Japanese_Map_symbol_%28Shrine%29.svg',
    sourcePage: 'https://commons.wikimedia.org/wiki/File:Japanese_Map_symbol_(Shrine).svg',
    title: 'Japanese Map symbol (Shrine)',
    license: 'Public domain',
  },
  police_box: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/3/34/Japanese_Map_symbol_%28Koban%29.svg',
    sourcePage: 'https://commons.wikimedia.org/wiki/File:Japanese_Map_symbol_(Koban).svg',
    title: 'Japanese Map symbol (Koban)',
    license: 'Public domain',
  },
  police_station: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/5/58/Japanese_Map_symbol_%28Police_station%29.svg',
  ...
  fire_station: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/0/0e/Japanese_Map_symbol_%28Fire_station%29.svg',
  ...
  factory: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/2/2c/Japanese_Map_symbol_%28Factory%29.svg',
    sourcePage: 'https://commons.wikimedia.org/wiki/File:Japanese_Map_symbol_(Factory).svg',
    title: 'Japanese Map symbol (Factory)',
    license: 'Public domain',
  },
  health_center: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/2/2e/Japanese_Map_symbol_%28Health_center%29.svg',
  ...
  hospital: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/0/03/Japanese_Map_symbol_%28Hospital%29.svg',
    sourcePage: 'https://commons.wikimedia.org/wiki/File:Japanese_Map_symbol_(Hospital).svg',
    title: 'Japanese Map symbol (Hospital)',
    license: 'Public domain',
  },
  rice_field: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/8/85/Japanese_Map_symbol_%28Rice_field%29.svg',
    sourcePage: 'https://commons.wikimedia.org/wiki/File:Japanese_Map_symbol_(Rice_field).svg',
    title: 'Japanese Map symbol (Rice field)',
    license: 'Public domain',
  },
  farm: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/0/01/Japanese_Map_symbol_%28Field%29.svg',
    sourcePage: 'https://commons.wikimedia.org/wiki/File:Japanese_Map_symbol_(Field).svg',
    title: 'Japanese Map symbol (Field)',
    license: 'Public domain',
  },
  orchard: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/c/c9/Japanese_Map_symbol_%28Orchard%29.svg',
    sourcePage: 'https://commons.wikimedia.org/wiki/File:Japanese_Map_symbol_(Orchard).svg',
    title: 'Japanese Map symbol (Orchard)',
    license: 'Public domain',
  },
  tea_field: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/d/d2/Japanese_Map_symbol_%28Tea_plantation%29.svg',
  ...
  broadleaf_forest: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/a/a5/Japanese_Map_symbol_%28Broadleaf_trees%29.svg',
  ...
  conifer_forest: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/7/71/Japanese_Map_symbol_%28Coniferous_trees%29.svg',
  ...
  cemetery: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/d/d6/Japanese_Map_symbol_%28Graveyard%29.svg',
    sourcePage: 'https://commons.wikimedia.org/wiki/File:Japanese_Map_symbol_(Graveyard).svg',
    title: 'Japanese Map symbol (Graveyard)',
    license: 'Public domain',
  },
  castle_ruins: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/f/f2/Japanese_Map_symbol_%28Castle%29.svg',
    sourcePage: 'https://commons.wikimedia.org/wiki/File:Japanese_Map_symbol_(Castle).svg',
    title: 'Japanese Map symbol (Castle)',
    license: 'Public domain',
  },
  self_defense_force: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/2/2d/Japanese_Map_symbol_%28the_Self-Defense_Forces%29.svg',
  ...
  lighthouse: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/6/6d/Japanese_Map_symbol_%28Lighthouse%29.svg',
    sourcePage: 'https://commons.wikimedia.org/wiki/File:Japanese_Map_symbol_(Lighthouse).svg',
    title: 'Japanese Map symbol (Lighthouse)',
    license: 'Public domain',
  },
  court: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/b/be/Japanese_Map_symbol_%28Court_of_law%29.svg',
  ...
  wasteland: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/5/52/Japanese_Map_symbol_%28Barren_land%29.svg',
  ...
  government_office: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/1/1b/Japanese_Map_symbol_%28Government_or_Municipal_office%29.svg',
  ...
  power_station: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/3/35/Japanese_Map_symbol_%28Power_plant%29.svg',
  ...
  weather_station: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/5/59/Japanese_Map_symbol_%28Meteorological_observatory%29.svg',
  ...
  museum: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/c/c0/Japanese_Map_symbol_%28Museum%29.svg',
    sourcePage: 'https://commons.wikimedia.org/wiki/File:Japanese_Map_symbol_(Museum).svg',
    title: 'Japanese Map symbol (Museum)',
    license: 'Public domain',
  },
  library: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/2/27/Japanese_Map_symbol_%28Library%29.svg',
    sourcePage: 'https://commons.wikimedia.org/wiki/File:Japanese_Map_symbol_(Library).svg',
    title: 'Japanese Map symbol (Library)',
    license: 'Public domain',
  },
  monument: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/e/e6/Japanese_Map_symbol_%28Monument%29.svg',
  ...
  electronic_control_point: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/e/e5/Japanese_Map_symbol_%28Electronic_Datum_point%29.svg',
  ...
  triangulation_point: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/1/12/Japanese_Map_symbol_%28Triangulation_point%29.svg',
  ...
  benchmark: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/7/7e/Japanese_Map_symbol_%28Standard_point%29.svg',
  ...
  mulberry_field: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/b/b6/Japanese_Map_symbol_%28Mulberry_field%29.svg',
  ...
  bamboo_grove: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/8/8d/Japanese_Map_symbol_%28Bamboo_grove%29.svg',
  ...
  smokestack: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/c/cd/Japanese_Map_symbol_%28Chimney%29.svg',
    sourcePage: 'https://commons.wikimedia.org/wiki/File:Japanese_Map_symbol_(Chimney).svg',
    title: 'Japanese Map symbol (Chimney)',
    license: 'Public domain',
  },
  crater: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/1/1f/Japanese_Map_symbol_%28Crater_or_Fumarole%29.svg',
  ...
  quarry: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/a/a3/Japanese_Map_symbol_%28Quarry%29.svg',
    sourcePage: 'https://commons.wikimedia.org/wiki/File:Japanese_Map_symbol_(Quarry).svg',
    title: 'Japanese Map symbol (Quarry)',
    license: 'Public domain',
  },
  oil_gas_well: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/4/4e/Japanese_Map_symbol_%28Oil_or_Gas_well%29.svg',
  ...
  historic_site: {
    src: 'https://upload.wikimedia.org/wikipedia/commons/6/6f/Japanese_Map_symbol_%28Historical_site-Place_of_scenic_beauty-Natural_monument-Protected_animal_plant%29.svg',
