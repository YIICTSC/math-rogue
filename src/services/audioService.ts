  ...
  public playMagicVoiceFile(heroId: string | undefined, voiceName: string | undefined, maxDurationMs = 2200, _transformed = false) {
      ...
      return this.playHtmlSfx(
          ...
          [
              ...
              versionBgmPath(assetUrl(`sfx/magic-voices/${safeHeroId}/${voiceNameForPath}.wav`)),
              versionBgmPath(`/sfx/magic-voices/${safeHeroId}/${voiceNameForPath}.ogg`),
              versionBgmPath(`/sfx/magic-voices/${safeHeroId}/${voiceNameForPath}.wav`),
              versionBgmPath(`sfx/magic-voices/${safeHeroId}/${voiceNameForPath}.ogg`),
              versionBgmPath(`sfx/magic-voices/${safeHeroId}/${voiceNameForPath}.wav`),
          ],
          maxDurationMs,
  ...
  public playHighSchoolVoiceFile(heroId: string | undefined, voiceName: string | undefined, maxDurationMs = 2600) {
      ...
      return this.playHtmlSfx(
          ...
          [
              ...
              versionBgmPath(assetUrl(`sfx/high-school-voices/${safeHeroId}/${safeVoiceName}.wav`)),
              versionBgmPath(`/sfx/high-school-voices/${safeHeroId}/${safeVoiceName}.ogg`),
              versionBgmPath(`/sfx/high-school-voices/${safeHeroId}/${safeVoiceName}.wav`),
              versionBgmPath(`sfx/high-school-voices/${safeHeroId}/${safeVoiceName}.ogg`),
              versionBgmPath(`sfx/high-school-voices/${safeHeroId}/${safeVoiceName}.wav`),
          ],
          maxDurationMs,
  ...
  public async playMagicEventVoice(heroId: string | undefined, lineId: string | undefined, delayMs = 0) {
      ...
      return this.playHtmlSfx(
          ...
          [
              ...
              versionBgmPath(assetUrl(`sfx/magic-event-voices/${safeHeroId}/${safeLineId}.wav`)),
              versionBgmPath(`/sfx/magic-event-voices/${safeHeroId}/${safeLineId}.ogg`),
              versionBgmPath(`/sfx/magic-event-voices/${safeHeroId}/${safeLineId}.wav`),
              versionBgmPath(`sfx/magic-event-voices/${safeHeroId}/${safeLineId}.ogg`),
              versionBgmPath(`sfx/magic-event-voices/${safeHeroId}/${safeLineId}.wav`),
          ],
          12000,
