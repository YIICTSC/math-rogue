...
export const SCHOOL_TRPG_COPY = {
  ...
  campaignHeader: trpgCopy('CAMPAIGN 00–05 + HIDDEN', 'キャンペーン れいぜろから ご + かくし', 'CAMPAIGN 00–05 + HIDDEN'),
  campaignTagline: trpgCopy('OPEN CAMPUS ADVENTURE // 全6章', 'オープンキャンパスアドベンチャー // ぜんろくしょう', 'OPEN CAMPUS ADVENTURE // SIX CHAPTERS'),
  chapterTwo: trpgCopy('第2章・時計塔の余白', 'だいにしょう・とけいとうのよはく', 'CHAPTER 2 // THE CLOCK TOWER MARGIN'),
  intro: trpgCopy('導入章から第5章、条件を満たすと隠し章へ続く全6章の探索キャンペーン。各章で問題ゲートを越え、仲間と結末を選びながら校章の記憶を完成させる。', 'どうにゅうしょうからだいごしょう、じょうけんをみたすとかくししょうへつづくぜんろくしょうのたんさくキャンペーン。かくしょうでもんだいゲートをこえ、なかまとけつまつをえらびながらこうしょうのきおくをかんせいさせる。', 'A six-chapter expedition from the prologue through Chapter 5, with a hidden chapter unlocked by research. Clear quiz gates, choose allies, and complete the emblem memory.'),
  specChapters: trpgCopy('6章構成', 'ろくしょうこうせい', '6 CHAPTERS'),
  specLocations: trpgCopy('36地点', 'さんじゅうろくちてん', '36 LOCATIONS'),
  specEndings: trpgCopy('25結末', 'にじゅうごけつまつ', '25 ENDINGS'),
  hiddenRouteHint: trpgCopy('第5章の調査を完了すると、隠し章「0時間目」が解禁されます。', 'だいごしょうのちょうさをかんりょうすると、かくししょう「れいじかんめ」がかいきんされます。', 'Complete the Chapter 5 research gate to unlock the hidden chapter: ZERO HOUR.'),
