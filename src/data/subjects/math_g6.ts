...
export const MATH_G6_DATA: Record<string, GeneralProblem[]> = {
    ...
    MATH_G6_1: [
        ...
        { question: "x ＝ 100 のとき、 x × 5 の値は？", answer: "500", options: d("500", "105", "20", "50"), hint: "100をxに代入（だいにゅう）して。" },
        ...
        { question: "「x ＋ x ＋ x」 を文字と式で表すと？（中学先取り）", answer: "3x", options: d("3x", "x³", "xxx", "x＋3"), hint: "x が 3つ あるね。" },
        { question: "「x × x × x」 を文字と式で表すと？（中学先取り）", answer: "x³（xの3乗）", options: d("x³", "3x", "xxx", "3＋x"), hint: "同じ数を3回かけるよ。" },
    ],
    ...
    MATH_G6_2: [
        ...
        { question: "円の面積を求める公式は？", answer: "半径 × 半計 × 円周率", options: d("半径 × 半径 × 円周率", "直径 × 円周率", "半径 × 2 × 円周率", "底辺 × 高さ"), hint: "3.14をかけるよ。" },
        ...
        { question: "反比例のグラフの形は？（中学先取り）", answer: "双曲線（そうきょくせん）", options: d("双曲線", "直線", "放物線", "折れ線"), hint: "なめらかな2つのカーブになるよ。" },
        ...
        { question: "「速さ」が一定のとき、時間 x と 距離 y は？", answer: "比例", options: d("比例", "反比例", "どちらでもない", "日による"), hint: "時間が経つほど距離は増えるね。" },
        ...
        { question: "相似（そうじ）な図形。拡大図や縮図の関係を何という？（中学先取り）", answer: "相似", options: d("相似", "合同", "平行", "対称"), hint: "形が同じであること。" },
        ...
        { question: "比例の式 y＝ax で、a がマイナスの数になることはある？（中学先取り）", answer: "ある", options: d("ある", "ない", "0のときだけ", "1より大きいときだけ"), hint: "中学に入ると「負（ふ）の数」が出てくるよ。" },
    ...
    MATH_G6_3: [
        ...
        { question: "データを大きさ順に並べた時、真ん中にくる値を何という？", answer: "中央値（メジアン）", options: d("中央値", "平均値", "最頻値", "最小値"), hint: "ちょうど真ん中の順位。" },
        { question: "データの中で最も頻繁（ひんぱん）に現れる値を？", answer: "最頻値（モード）", options: d("最頻値", "中央値", "平均値", "最大値"), hint: "一番人気のある値のこと。" },
        ...
        { question: "底面が 10cm²、高さが 6cm の「角錐（かくすい）」の体積は？（発展）", answer: "20cm³", options: d("20cm³", "60cm³", "30cm³", "10cm³"), hint: "柱の体積の 1/3 になるんだ。" },
        { question: "「速さ」の単位変換。 分速 100m は 時速何km？", answer: "時速 6km", options: d("時速 6km", "時速 60km", "時速 1km", "時速 100km"), hint: "100m × 60分 ＝ 6000m。" },
        { question: "データの散らばりを表す。最大値 － 最小値 を何という？", answer: "範囲（レンジ）", options: d("範囲", "階級", "度数", "誤差"), hint: "一番大きいところから一番小さいところまでの幅。" },
        ...
        { question: "「1, 4, 9, 16...」 次にくる数は？（発展）", answer: "25", options: d("25", "20", "30", "36"), hint: "1×1, 2×2, 3×3, 4×4..." },
        ...
        { question: "中学校の数学。 「マイナス」の世界、楽しみ？", answer: "楽しみ！", options: d("楽しみ！", "不安", "わからない", "普通"), hint: "世界がもっと広がるよ！" },
        { question: "「x ＝ 2, y ＝ 3」 のとき、 「x ＋ 2y」 の値は？（中学先取り）", answer: "8", options: d("8", "7", "5", "10"), hint: "2 ＋ 2×3 ＝ ?" },
