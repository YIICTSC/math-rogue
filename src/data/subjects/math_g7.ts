...
const MATH_G7_3: GeneralProblem[] = [
        ...
        { question: "「角錐（かくすい）」の体積を求める公式は？", answer: "底面積 × 高さ ÷ 3", options: d("底面積 × 高さ ÷ 3", "底面積 × 高さ", "底面積 × 高さ × 2", "半径³"), hint: "尖（とが）っている形は 1/3 になる。" },
        ...
        { question: "長方形を1回転させると何ができる？", answer: "円柱", options: d("円柱", "円錐", "球", "角柱"), hint: "トイレットペーパーの芯のような形。" },
        { question: "直角三角形を、直角をはさむ1辺を軸に回転させると？", answer: "円錐", options: d("円錐", "円柱", "球", "三角柱"), hint: "アイスのコーンのような形。" },
        ...
        { question: "円錐の展開図。側面はどのような形になる？", answer: "おうぎ形", options: d("おうぎ形", "長方形", "円", "三角形"), hint: "くるっと巻くと尖るよ。" },
        ...
        { question: "四角錐の頂点の数は？", answer: "5個", options: d("5個", "4個", "8個", "1個"), hint: "底面に4つ、てっぺんに1つ。" },
        { question: "円柱を真横から見ると、どんな形に見える？", answer: "長方形", options: d("長方形", "円", "正方形", "三角形"), hint: "投影図（立面図）の話だよ。" },
        { question: "円錐を真上から見ると、何が見える？", answer: "円と中心の点", options: d("円と点", "ただの円", "三角形", "点だけ"), hint: "てっぺんが中心に見える。" },
