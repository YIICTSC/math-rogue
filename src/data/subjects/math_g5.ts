...
export const MATH_G5_DATA: Record<string, GeneralProblem[]> = {
    ...
    MATH_G5_1: [
        { question: "「整数」の中で、2で割り切れる数を何という？", answer: "偶数（ぐうすう）", options: d("偶数", "奇数", "小数", "素数"), hint: "0, 2, 4, 6... だよ。" },
        { question: "「整数」の中で、2で割り切れない数を何という？", answer: "奇数（きすう）", options: d("奇数", "偶数", "整数", "自然数"), hint: "1, 3, 5, 7... だよ。" },
        { question: "0 は 偶数・奇数のどちらに含まれる？", answer: "偶数", options: d("偶数", "奇数", "どちらでもない", "小数"), hint: "教科書では0も偶数として扱うよ。" },
        { question: "「倍数（ばいすう）」とは？", answer: "ある数に整数をかけてできる数", options: d("整数をかけた数", "整数を足した数", "整数で割った数", "奇数のこと"), hint: "3の倍数は 3, 6, 9... だね。" },
        { question: "「公倍数（こうばいすう）」とは？", answer: "2つ以上の数に共通な倍数", options: d("共通な倍数", "共通な約数", "足した数", "かけた数"), hint: "3と4の公倍数は、12, 24... と続くよ。" },
        ...
        { question: "10 の約数をすべて挙げると？", answer: "1, 2, 5, 10", options: d("1, 2, 5, 10", "1, 2, 4, 10", "2, 5", "1, 10"), hint: "1と自分自身を忘れないで。" },
        ...
        { question: "体積の単位。 1cm × 1cm × 1cm の大きさを？", answer: "1cm³（立方センチメートル）", options: d("1cm³", "1cm²", "1m³", "1mL"), hint: "「立方（りっぽう）」は3乗のこと。" },
        ...
        { question: "3日間の歩数が、5000歩, 7000歩, 6000歩。平均は？", answer: "6000歩", options: d("6000歩", "18000歩", "5000歩", "7000歩"), hint: "全部足して3で割る。" },
    ...
    MATH_G5_2: [
        { question: "「小数の割り算」。 「6 ÷ 0.5 ＝ 」 答えは？", answer: "12", options: d("12", "3", "0.3", "6.5"), hint: "0.5(半分)で割ると、数は2倍になるよ。" },
        { question: "「4.8 ÷ 1.2 ＝ 」 答えは？", answer: "4", options: d("4", "40", "0.4", "6"), hint: "両方を10倍して 48÷12 として考えよう。" },
        { question: "小数の割り算で、わる数が1より小さいとき、商はどうなる？", answer: "わられる数より大きくなる", options: d("大きくなる", "小さくなる", "変わらない", "0になる"), hint: "0.1で割ると10倍になるイメージ。" },
        ...
        { question: "割り進む筆算。 5 ÷ 4 ＝ ？", answer: "1.25", options: d("1.25", "1.2", "1.1", "0.8"), hint: "あまりに0をつけて続けて割るよ。" },
        ...
        { question: "ひし形の面積を求める公式は？", answer: "対角線 × 対角線 ÷ 2", options: d("対角線 × 対角線 ÷ 2", "底辺 × 高さ", "一辺 × 一辺", "辺の合計"), hint: "周りの長方形の半分。" },
    ...
    MATH_G3_3: [
        ...
        { question: "底面が半径2cmの円、高さが5cmの円柱の体積は？（π=3.14）", answer: "62.8cm³", options: d("62.8cm³", "20cm³", "31.4cm³", "12.56cm³"), hint: "2×2×3.14×5 ＝ ?" },
        ...
        { question: "「x ＋ 5 ＝ 12」 x はいくつ？", answer: "7", options: d("7", "17", "5", "60"), hint: "12 － 5 ＝ ?" },
        { question: "「x × 4 ＝ 32」 x はいくつ？", answer: "8", options: d("8", "36", "28", "128"), hint: "32 ÷ 4 ＝ ?" },
        ...
        { question: "割合。 「0.2」 を百分率で？", answer: "20%", options: d("20%", "2%", "0.2%", "200%"), hint: "100をかける。" },
