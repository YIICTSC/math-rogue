...
export const UI_PREVIEW_SCREENS: UiPreviewScreenDefinition[] = [
    ...
    { id: GameScreen.MATH_CHALLENGE, screen: GameScreen.MATH_CHALLENGE, label: '問題画面（板書・報酬）', group: 'メインモード' },
    ...
    { id: `${GameScreen.MINI_GAME_POKER}:POKER_PACK`, screen: GameScreen.MINI_GAME_POKER, label: '放課後ポーカー：ランダムパック', group: 'ミニゲーム', miniGameOutcome: 'POKER_PACK' },
